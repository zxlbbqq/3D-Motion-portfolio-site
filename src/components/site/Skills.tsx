...
const groups = [
  {
    ...
    title: { ru: "3D", en: "3D" },
    desc: {
      ru: "Моделинг, рендер, симуляции",
      en: "Modelling, rendering, simulations",
    },
    items: [
      "Cinema 4D",
      "Redshift",
  ...
  },
  {
    ...
    desc: {
      ru: "Монтаж, моушн-графика, UI и графический дизайн",
      en: "Editing, motion graphics, UI and graphic design",
    },
    items: [
      "Davinci Resolve",
      "Figma",
